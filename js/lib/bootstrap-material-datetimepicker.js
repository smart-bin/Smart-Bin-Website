(function($, moment)
{
	...
	function Plugin(element, options)
	{
		...
		this.params = { date : true, time : true, format : 'YYYY-MM-DD', minDate : null, maxDate : null, currentDate : null, lang : 'en', weekStart : 0, shortTime : false, 'cancelText' : 'Cancel', 'okText' : 'OK', showHeader : false };
			...
			this.template = '<div class="dtp hidden hide" id="' + this.name + '">' +
								'<div class="dtp-content">' +
									...
									'<div class="dtp-buttons">' +
										...
										'<button class="dtp-btn-ok mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">' + this.params.okText + '</button>' +
										'<div class="clearfix"></div>' +
									'</div>' +
								'</div>' +
							'</div>';
